...
#'
#' @return Valor de probabilidad para los parámetros dados
#'
#' @details
...
#' @examples
#' \dontrun{
#'   dbetabinom(x = 5, n = 10, alpha = 2, beta = 2)
#' }
#'
#' @noRd
...
#' UI Function
#'
#' @title Interfaz de usuario para la aplicación Shiny del explorador Beta Binomial
#' @description Interfaz de usuario para la aplicación Shiny del explorador Beta Binomial
#' @return Una interfaz de usuario Shiny
#' @export
ui <- page_fluid(
...
#' @encoding UTF-8
#' @title Función de Masa de Probabilidad Beta-Binomial
#' @description Implementa la lógica del servidor para la aplicación Shiny
#' de exploración beta-binomial.
#'
#' @param input Valores de entrada de la interfaz de usuario
#' @param output Salidas a actualizar
#' @param session Sesión actual de Shiny
#'
#' @details
#' El servidor maneja:
#' \enumerate{
#'   \item Cálculo de parámetros alpha y beta
#'   \item Generación de gráficos con ggplot2
#'   \item Cálculo de estadísticas
#'   \item Generación de explicaciones
#' }
#'
...
#' @encoding UTF-8
#' @title Función de Masa de Probabilidad Beta-Binomial
#' @description Ejecuta la aplicación Shiny del explorador Beta Binomial
