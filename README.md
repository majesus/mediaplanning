...
![Tabla de cálculo de MEF/c](./img/img_FEM_table.png)
...
| **3. Communication objectives**      ||                                     || Brand recognition <br> Informational brand attitude ||                             ||                                               || Brand recall <br> Transformational brand attitude |
| **4. Personal influence**            || High (average contact ≥ 0.25)       ||                                    || Low (average contact < 0.25) ||                                               ||                                       |

* **LC + 1***: If market share leader, use +2 exposures; if not leader, set equal to largest competitor’s average frequency +1 (called LC + 1). LC + 1 is additive on the 1 only; for example, a campaign aimed at new category users with brand recall and transformational brand attitude objectives would use LC + 3 exposures.
